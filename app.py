...
# --- 2단계: 이탈의 임계점 분석 ---
    ...
    with tab3:
        ...
        st.markdown("""
        * **현상:** 
            1. 검색 포기율은 ‘문제 지표’가 아님(평균 51.9%). 무클릭 종료는 예외가 아니라 기본 상태
            2. 포기 맥락상 위험군: Decision Fatigue(51.62%). 장기 이탈 위험 높음 
            3. 이탈은 ‘Deep Consideration’에서 이미 시작되며, 검색 포기자 중 이탈률 가장 높음(15.87%). 이 구간부터 집중적인 케어 필요
